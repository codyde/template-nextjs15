...
export const metadata: Metadata = {
  title: "Sentry.New - Next.js Template",
  description: "A Next.js template built for Sentry.New app builder with shadcn/ui components",
};
